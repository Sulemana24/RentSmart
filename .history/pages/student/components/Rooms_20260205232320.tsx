  ...
  return (
    <div className="space-y-6">
      ...
      {(activeModal === "add" || activeModal === "edit") && (
        <Modal title={activeModal === "add" ? "Add New Room" : "Edit Room Data"} onClose={() => setActiveModal(null)}>
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button type="submit" className="px-6 py-2 bg-[#00CFFF] text-white rounded-lg font-bold shadow-lg shadow-[#00CFFF]/20">Save Room</button>
            </div>
          </form>
        </Modal>
      )}
